...
const Icons = styled(Box)(({theme}) => ({
    display: "none", gap: theme.spacing(1), alignItems: "center", [theme.breakpoints.up("sm")]: {
        display: "flex",
    },
}));
...
const Navbar = ({openSideBar, setOpenSideBar}) => {
    ...
    return (<AppBar position="sticky">
            <StyledToolbar>
                ...
                <MenuIcon onClick={event => setOpenSideBar(!openSideBar)} sx={{display: {xs: "block", sm: "none"}}}/>
                <Search>
